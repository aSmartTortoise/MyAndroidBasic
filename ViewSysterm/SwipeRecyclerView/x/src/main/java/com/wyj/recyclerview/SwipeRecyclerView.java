...
import com.wyj.recyclerview.touch.DefaultItemTouchHelper;
import com.wyj.recyclerview.touch.OnItemMoveListener;
import com.wyj.recyclerview.touch.OnItemMovementListener;
import com.wyj.recyclerview.touch.OnItemStateChangedListener;
import com.wyj.recyclerview.widget.DefaultLoadMoreView;
...
/**
 * Created by Jie Wong on 2016/7/27.
 */
public class SwipeRecyclerView extends RecyclerView {
    ...
    private AdapterDataObserver mAdapterDataObserver = new AdapterDataObserver() {
        ...
        public void onItemRangeRemoved(int positionStart, int itemCount) {
            positionStart += getHeaderCount();
            Log.d(TAG, "onItemRangeRemoved: wyj positionStart:" + positionStart);
        ...
        public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
            ...
            Log.d(TAG, "onItemRangeMoved: wyj fromPosition:" + fromPosition + " toPosition:" + toPosition);
    ...
    public void smoothOpenMenu(int position, @DirectionMode int direction, int duration) {
        Log.d(TAG, "smoothOpenMenu: wyj position:" + position);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                Log.d(TAG, "dispatchTouchEvent: wyj down");
                break;
            }
            case MotionEvent.ACTION_MOVE: {
                Log.d(TAG, "dispatchTouchEvent: wyj move");
                break;
            }
            case MotionEvent.ACTION_UP: {
                Log.d(TAG, "dispatchTouchEvent: wyj up");
                break;
            }
            case MotionEvent.ACTION_CANCEL: {
                Log.d(TAG, "dispatchTouchEvent: wyj cancel");
                break;
            }
        }
        boolean result = super.dispatchTouchEvent(ev);
        Log.d(TAG, "dispatchTouchEvent: wyj result:" + true);
        return result;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        ...
        if (allowSwipeDelete || mSwipeMenuCreator == null) {
            ...
            Log.d(TAG, "onInterceptTouchEvent: wyj x:" + x + " y:" + y + " touchPosition:" + touchPosition
            + " action:" + action);
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                break;
            case MotionEvent.ACTION_CANCEL:
                Log.d(TAG, "onTouchEvent: wyj cacel");
                break;
        }
    ...
    public void onScrollStateChanged(int state) {
        ...
        Log.d(TAG, "onScrollStateChanged: wyj state:" + state);
    }
    ...
    public void onScrolled(int dx, int dy) {
        ...
        if (layoutManager instanceof LinearLayoutManager) {
            ...
            Log.d(TAG, "onScrolled: wyj itemCount:" + itemCount + " lastVisiblePosition:"
            + lastVisiblePosition);
            Log.d(TAG, "onScrolled: wyj mScrollState:" + mScrollState);

            if (itemCount == lastVisiblePosition + 1 &&
                (mScrollState == SCROLL_STATE_DRAGGING || mScrollState == SCROLL_STATE_SETTLING)) {
                Log.d(TAG, "onScrolled: wyj dispatchLoadMore");
                dispatchLoadMore();
            }
            ...
            Log.d(TAG, "onScrolled: wyj lastVisiblePositionArray:" + lastVisiblePositionArray
    ...
    private void dispatchLoadMore() {
        Log.d(TAG, "dispatchLoadMore: wyj isLoadError:" + isLoadError + " isAutoLoadMore:"
        + isAutoLoadMore + " isLoadMore:" + isLoadMore + " mDataEmpty:" + mDataEmpty
        + " mHasMore:" + mHasMore);
    ...
    public final void loadMoreFinish(boolean dataEmpty, boolean hasMore) {
        Log.d(TAG, "loadMoreFinish: wyj dataEmpty:" + dataEmpty + " hasMore:" + hasMore);
        isLoadMore = false;
        isLoadError = false;
        ...
        if (mLoadMoreView != null) {
            Log.d(TAG, "loadMoreFinish: wyj onLoadFinish");
