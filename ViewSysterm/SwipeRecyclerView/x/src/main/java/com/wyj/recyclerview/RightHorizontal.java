...
/**
 * Created by Jie Wong on 2016/7/22.
 */
class RightHorizontal extends Horizontal {
    private static final String TAG = "RightHorizontal";
    ...
    public void autoOpenMenu(OverScroller scroller, int scrollX, int duration) {
        Log.d(TAG, "autoOpenMenu: wyj width:" + getMenuView().getWidth()
        + " scrollX:" + scrollX);
...
//        Log.d(TAG, "autoCloseMenu: wyj scrollX:" + scrollX);
    ...
    public Checker checkXY(int x, int y) {
        ...
        Log.d(TAG, "checkXY: wyj MenuView width:" + getMenuView().getWidth());
