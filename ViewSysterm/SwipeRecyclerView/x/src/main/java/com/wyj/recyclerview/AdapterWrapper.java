...
import static com.wyj.recyclerview.SwipeRecyclerView.LEFT_DIRECTION;
import static com.wyj.recyclerview.SwipeRecyclerView.RIGHT_DIRECTION;

/**
 * Created by Jie Wong on 2017/7/20.
 */
class AdapterWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        Log.d(TAG, "onCreateViewHolder: wyj inflate x recycler view item");
        ...
        try {
            ...
            Log.d(TAG, "onCreateViewHolder: wyj set itemView");
    ...
    public final void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position,
        ...
        Log.d(TAG, "onBindViewHolder: wyj position:" + position);
        if (isHeaderOrFooter(holder)) return;

        View itemView = holder.itemView;
        position -= getHeaderCount();
        Log.d(TAG, "onBindViewHolder: wyj content view position:" + position);
        ...
        if (itemView instanceof SwipeMenuLayout && mSwipeMenuCreator != null) {
            ...
            if (leftMenu.hasMenuItems()) {
                ...
                leftMenuView.createMenu(
                        holder, leftMenu, menuLayout, LEFT_DIRECTION, mOnItemMenuClickListener);
            ...
            if (rightMenu.hasMenuItems()) {
                ...
                rightMenuView.createMenu(
                        holder, rightMenu, menuLayout, RIGHT_DIRECTION, mOnItemMenuClickListener);
    ...
    public void onAttachedToRecyclerView(@NonNull RecyclerView recyclerView) {
        Log.d(TAG, "onAttachedToRecyclerView: wyj");
    ...
    public void onViewAttachedToWindow(@NonNull RecyclerView.ViewHolder holder) {
        ...
        Log.d(TAG, "onViewAttachedToWindow: wyj adapterPosition:" + adapterPosition);
    ...
    public void onViewRecycled(@NonNull RecyclerView.ViewHolder holder) {
        Log.d(TAG, "onViewRecycled: wyj position:" + holder.getAdapterPosition());
    ...
    public void onViewDetachedFromWindow(@NonNull RecyclerView.ViewHolder holder) {
        int adapterPosition = holder.getAdapterPosition();
        Log.d(TAG, "onViewDetachedFromWindow: wyj adapterPosition:" + adapterPosition);
