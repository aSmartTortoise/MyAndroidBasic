 ...
 */
package com.wyj.recyclerview.sample.activity.menu;
...
import com.wyj.recyclerview.OnItemMenuClickListener;
import com.wyj.recyclerview.SwipeMenu;
import com.wyj.recyclerview.SwipeMenuBridge;
import com.wyj.recyclerview.SwipeMenuCreator;
import com.wyj.recyclerview.SwipeMenuItem;
import com.wyj.recyclerview.sample.R;
import com.wyj.recyclerview.sample.activity.BaseActivity;
import com.wyj.recyclerview.sample.adapter.MainAdapter;
...
public class ListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: wyj setAdapter");
...
//            }
            if (menuPosition == 0) {
                if (mAdapter instanceof MainAdapter) {
                   List<String> dataList =  ((MainAdapter) mAdapter).getDataList();
                    Log.d(TAG, "onItemClick: wyj position:" + position);
