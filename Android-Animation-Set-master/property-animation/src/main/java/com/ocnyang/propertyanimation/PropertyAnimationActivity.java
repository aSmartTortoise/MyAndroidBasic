...
//        animatorSet.setTarget(mPuppet);
    ...
    public Animator getObjectAnimatorByPropertyValuesHolder() {
        ...
        PropertyValuesHolder rotationXAnimator = PropertyValuesHolder.ofFloat("rotationX",
                0f, 360f);
        ObjectAnimator objectAnimator = ObjectAnimator.ofPropertyValuesHolder(mPuppet,
    ...
    public ValueAnimator getValueAnimator() {
        ...
        sizeValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                float animatedValue = (float) valueAnimator.getAnimatedValue();
                ViewGroup.LayoutParams layoutParams = mPuppet.getLayoutParams();
                layoutParams.height = (int) (height * animatedValue);
                layoutParams.width = (int) (width * animatedValue);
                mPuppet.requestLayout();
//                mPuppet.setLayoutParams(layoutParams);
//                mPuppet.invalidate();
            }
        });
...
//        animatorSet.playTogether(getObjectAnimatorByPropertyValuesHolder());
        animatorSet.playTogether(getValueAnimator());
